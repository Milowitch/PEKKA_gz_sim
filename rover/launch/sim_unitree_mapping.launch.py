...
def generate_launch_description():
    ...
    parameters = {
        'frame_id': 'base_footprint',  # TF frame for ICP alignment
        'odom_frame_id': 'odom',  # Odometry frame
        'wait_for_transform': 0.8,
        'use_sim_time': use_sim_time,
        'scan_voxel_size': 0.1,  # Matching voxel size with sensor resolution
        'Icp/VoxelSize': '0.1',
        'scan_normal_k': 10,  # Use more neighbors for better normal estimation
        'Icp/PointToPlaneK': '10',
        # 'scan_range_max': 30.0,  # Max range of lidar (from Gazebo sensor)
        # 'scan_range_min': 0.05,  # Min range of lidar (from Gazebo sensor)
        'scan_keyframe_threshold': 0.5,
        'Icp/Iterations': '10',  # Iterations for robust matching
        'Icp/Epsilon': '0.001',
        'Icp/PointToPlane': 'true',
        'Icp/PointToPlaneRadius': '0',  # Radius setting for ICP
        'Icp/MaxTranslation': '2',  # Max translation for matching
        'Icp/MaxCorrespondenceDistance': '1.0',  # Distance for valid point matching
        'Icp/Strategy': '1',
        ...
        'OdomF2M/ScanMaxSize': '21600',  # Adjusted for lidar point density
