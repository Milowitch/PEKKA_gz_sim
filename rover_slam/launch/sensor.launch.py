...
def generate_launch_description():
    ...
    declare_deskewing = DeclareLaunchArgument(
    ...
    parameters={
        ...
        'Optimizer/Strategy': '1',      # Graph optimization strategy: 0=TORO, 1=g2o and 2=GTSAM
    ...
    parameters_icp={
        ...
        'Icp/PointToPlaneK': '50',              # จำนวนเพื่อนบ้านที่จะคำนวณค่าปกติสำหรับจุดต่อระนาบ
